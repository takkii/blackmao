    ...
    def gather_candidates(self, context):
        ...
        # TraceBack.
            ...
            filepath = os.path.expanduser(
                "~/.vim/plugged/heimao/rplugin/python3/deoplete/sources/heimao.py"
            )
            ...
            # Load/Create LogFile.
            heimao: Optional[str] = str(filename)
            db_w: Optional[str] = os.path.expanduser('~/' + filename +
                                                     '/debug.log')

            # Load the dictionary.
            if os.path.isdir(heimao):
            ...
            # heimao Foler not found.
            else:
                raise ValueError("None, Please Check the heimao Folder.")
